...
$ cat urls.txt | httpx -follow-redirects -mc 403 -silent | purl -p http://127.0.0.1:8080 -h "X-BugBounty: hunter" -h "X-Custom-IP-Authorization: 127.0.0.1" -H 403-bypass.txt -c 50
```
<br />
